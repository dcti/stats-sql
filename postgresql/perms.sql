\set ON_ERROR_STOP 1
 ...
 grant insert, Update on Email_Contrib_Last_Update to group processing;
 ...
 grant insert, Update on Email_Rank_Last_Update to group processing;
 grant Select on Team_Rank_Last_Update to public;
 grant insert, Update on Team_Rank_Last_Update to group processing;
 grant Select on Team_Members_Last_Update to public;
 grant insert, Update on Team_Members_Last_Update to group processing;
 ...
 grant insert, Update on Platform_Contrib_Last_Update to group processing;
