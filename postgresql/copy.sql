-- $Id: copy.sql,v 1.7 2003/04/09 16:22:03 decibel Exp $
\set ON_ERROR_STOP 1
...
COPY Projects (PROJECT_ID, PROJECT_TYPE, NAME, STATUS, START_DATE, END_DATE, DUE_DATE, PRIZE, DESCRIPTION, DIST_UNIT_QTY, DIST_UNIT_NAME, WORK_UNIT_QTY, WORK_UNIT_DISP_MULTIPLIER, WORK_UNIT_DISP_DIVISOR, WORK_UNIT_IMPORT_MULTIPLIER, UNSCALED_WORK_UNIT_NAME, SCALED_WORK_UNIT_NAME, LOGFILE_PREFIX, SPONSOR_URL, SPONSOR_NAME, LOGO_URL) FROM '/home/decibel/blower/Projects.bcp' WITH DELIMITER '\t' NULL '';
